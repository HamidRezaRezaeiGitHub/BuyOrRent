...
export interface MaintenanceAmountFieldProps {
    id?: string;
    value: number;
...
export const MaintenanceAmountField: FC<MaintenanceAmountFieldProps> = ({
    ...
    const fieldConfig = defaultConfigProvider.getField('purchase', 'maintenanceAmount');
                ...
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                    <TooltipTrigger asChild>
                        <button
                            type="button"
                            className="ml-1"
                            aria-label="More information about Maintenance Amount"
                    ...
                    <TooltipContent side="right" className="max-w-xs" id={`${id}-tooltip`}>
                        <div className="text-xs">
                            <p>
                                The estimated annual maintenance and repair costs in dollars. Includes routine upkeep, repairs, and improvements.
                            </p>
                        </div>
                    </TooltipContent>
                </Tooltip>
    ...
    const sliderComponent = (
        <Slider
            ...
            aria-label={`Maintenance amount: $${validatedValue}`}
    ...
    const inputComponent = (
        <InputGroup className={displayMode === 'combined' ? 'w-32' : 'w-full'}>
            ...
            <InputGroupInput
                ...
                disabled={disabled}
                aria-label={`Maintenance amount in dollars, current value: $${validatedValue}`}
...
export default MaintenanceAmountField;
